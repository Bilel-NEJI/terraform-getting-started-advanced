...
# Step 31 | task 1: Consuming Modules from the Terraform Module Registry S3-bucket
# here we come and add that s3-bucket module with an output
# then we install that module with "init" --> "apply"
module "s3-bucket" {
...
# # Step 31 | task 2: Exploring other modules from the Terraform Module Registry
