# Step 34 | task 1: Standard Backend: S3 (more configuration for standard backend)
/*
...
# Step 34 | task 1: Standard Backend: S3 (more configuration for standard backend)
# in order to have a little example with terraform versioning using aws s3-bucket
# we will change here the "instance_type": from a "t2.micro" --to--> "t2.small"
# then "apply"
# Terraform Resource Block - To Build EC2 instance in Public Subnet
resource "aws_instance" "web_server_2" {
  ami           = data.aws_ami.ubuntu.id
  # this is the change that we talked about: from a "t2.micro" --to--> "t2.small"
  # instance_type = "t2.micro"
...
# Step 32 | task3: Terraform Module Version Constraints
module "vpc" {
