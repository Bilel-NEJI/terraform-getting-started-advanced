# Step 30 | task 3: Reference Child Module Outputs
/*
...
# Step 30 | task 3: Reference Child Module Outputs
# this is the out that we are going to create an output block (to look at the autoscaling group max size)
# --> "validate" --> "apply" --> this will work
output "asg_group_size" {
  value = module.autoscaling.autoscaling_group_max_size
}

# Step 30 | task 4: Invalid Module References
# this is an invalid reference; because we can not reference the max size directly, we need to reference the output that the child module is setting that value to
# --> "validate" --> this will work
# --> "apply" --> this will not work
output "asg_group_size" {
