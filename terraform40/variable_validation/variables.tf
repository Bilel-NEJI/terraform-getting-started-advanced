# Step 43 | task 1: Validate variables in a configuration block
variable "cloud" {
  type = string
...
# Step 43 | task 2: More Validation Options
variable "no_caps" {
  type = string
  validation {
...
# Step 43 | task 3: Suppress sensitive information (hide sensitive values from the terminal)
